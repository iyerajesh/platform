...
public class AttributesImpl implements Attributes {
    ...
    /**
     * Creates the marshaller instance to marshall {@link io.cloudevents.v03.AttributesImpl} as
     * a {@link Map} of strings
     */
    public static Map<String, String> marshal(io.cloudevents.v03.AttributesImpl attributes) {
     ...
     */
    public static io.cloudevents.v03.AttributesImpl unmarshal(Map<String, String> attributes) {
        ...
        return io.cloudevents.v03.AttributesImpl.build(id, source, specversion, type,
